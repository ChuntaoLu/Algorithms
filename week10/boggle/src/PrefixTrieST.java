/*************************************************************************
 *  Compilation:  javac PrefixTrieST.java
 *  Execution:    java PrefixTrieST < words.txt
 *  Dependencies: StdIn.java
 *
 *  A string symbol table for extended ASCII strings, implemented
 *  using a 256-way trie.
 *
 *  % java PrefixTrieST < shellsST.txt
 *  by 4
 *  sea 6
 *  sells 1
 *  she 0
...
public class PrefixTrieST<Value> {
   ...
   /**
    ...
    public static void main(String[] args) {
        ...
        PrefixTrieST<Integer> st = new PrefixTrieST<Integer>();
